...
import com.bhaskar.bigoh.combinedapp.client.FlightModeBroadcastReceiver
import com.bhaskar.bigoh.combinedapp.databinding.FragmentBroadCastBinding

class BroadcastReceiverClass : Fragment() {
    private lateinit var binder: FragmentBroadCastBinding
    private lateinit var receiver: FlightModeBroadcastReceiver
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binder.clickText.setOnClickListener {
            LocalBroadcastManager.getInstance(it.context)
                .registerReceiver(localBroadcast, IntentFilter("Local-Broadcast"))
        ...
        receiver = FlightModeBroadcastReceiver()
